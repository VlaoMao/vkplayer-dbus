...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Apr 18 12:24:37 2012
# Project:  vkplayer.pro
# Template: subdirs
# Command: /usr/bin/qmake -spec /usr/share/qt/mkspecs/linux-g++ -o Makefile vkplayer.pro
#############################################################################
...
src/$(MAKEFILE): 
	...
	cd src/ && $(QMAKE) /home/vl/workspace/qt/vkplayer/src/src.pro -spec /usr/share/qt/mkspecs/linux-g++ -o $(MAKEFILE)
...
Makefile: vkplayer.pro  /usr/share/qt/mkspecs/linux-g++/qmake.conf /usr/share/qt/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/share/qt/mkspecs/linux-g++ -o Makefile vkplayer.pro
